# CloudInBuzunar operations guide

Detailed installation, administration and recovery notes for the project.
For the overview and screenshots, return to the [main README](../README.md).
...
scripts/install-vaultwarden.sh \
  --host PHONE_TAILSCALE_IP \
  --additional-host PHONE_LAN_IP \
  --https-port 9443 \
  --start
```
...
# Create the account at https://PHONE_TAILSCALE_IP:9443
...
The Android companion can monitor this server independently and
